...
1. Consult a subject matter expert (SME), see [#9: the importance of domain expertise](https://www.linkedin.com/pulse/10-key-constraints-data-science-teams-digital-leaders-p-b-k-chaitanya/), to better understand the goals and data.  THEN columns/tables can be `dropped`.
